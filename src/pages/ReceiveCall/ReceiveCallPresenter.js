...
const ReceiveCallPresenter = () => {
  return (
    <Container>
      <Text fontSize={18} fontWeight="bold" margin="0 0 15px 0">
        전화 왔습니다
      </Text>
      <Text fontSize={20} fontWeight="bold" margin="0 0 40px 0">
        {"BMW X5"} 차주
      </Text>
...
export default ReceiveCallPresenter;
